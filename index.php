          ...
          <div class="container">
               <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                         ...
                         <div class="wow fadeInUp" data-wow-delay="0.8s">
                              <p> <br><br>Also, we provide an opportunity to each citizen to volunteer for helping
                                   other citizens by providing the goods.
                              </p>
                         </div>

                         <div class="wrapper"> 
                              <div class="app">                                       
                                   <button type="button"><a href="#appointment">Apply for Volunteering</a></button>              
                              </div>
                         </div>
                         ...
                         <div class="wow fadeInUp" data-wow-delay="0.8s">
                              <p> <br><br>Manufacturers, distributors and retailers can update their information
                                   from time to time, making it easy for the citizens to reach them.
                              </p>
                         </div>

                         <div class="wrapper"> 
                              <div class="app">                                       
                                   <button type="button"><a href="#info">Update Information</a></button>
